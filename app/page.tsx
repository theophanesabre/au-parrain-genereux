...
export default function Home() {
  return <main className="white-site vever-home focused-home">
    ...
    <section className="index-editorial index-editorial--chapter">
      <Link className="index-editorial__image" href="/maison" aria-label="Découvrir la Maison"><Image src="/images/maison-editorial.png" alt="La Maison Au Parrain Généreux, rue de Paris au Havre" fill quality={95} sizes="(max-width: 900px) 84vw, 560px" /></Link>
